...
setup(name='denominator_graph',
      ext_modules=[CppExtension('denominator_graph', ['src/chain-den-graph.cc'],
...
#      ext_modules=[CppExtension('pychain', ['src/chain-numerator.cc', 'src/chain-denominator.cc', 'src/chain-training.cc'])],
#      cmdclass={'build_ext': BuildExtension})
