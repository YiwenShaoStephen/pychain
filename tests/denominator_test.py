...
den_fst = simplefst.StdVectorFst.read(
    "/export/a16/vmanoha1/pychain/tests/den.fst")
den_graph = pychain.DenominatorGraph(den_fst, D, False)
...
objf = pychain.compute_objf_and_deriv(
    training_opts, den_graph, 1, nnet_output, nnet_output_deriv)
